...
export default class App extends React.Component {
  ...
  toggleCompleted(todoId) {
     ...
     * And specify the "Content-Type" header as "application/json"
     */
    // const currentIndex = this.state.todos[]
    let index;
    ...
    const currentStatus = this.state.todos[index].isCompleted;
    ...
    fetch(`/api/todos/${todoId}`, {
      ...
      body: JSON.stringify(newCompletedStatus)
    })
      .then(res => res.json())
      .then(newCompletedStatus => {
        const copyState = [...this.state.todos];
        copyState[index].isCompleted = newCompletedStatus.isCompleted;
        this.setState({
          todos: copyState
        });
      });
